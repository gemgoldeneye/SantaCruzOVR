  ...
  return (
    <Link href="/admin" className="flex items-center gap-2.5">
      ...
      <span className="leading-tight">
        ...
        <span className="block text-[0.7rem] text-sidebar-foreground/65">
          {copy.admin.portal}
        </span>
      </span>
    </Link>
...
/** Desktop sidebar — an in-flow column that fills the content row's height. */
export function AdminSidebar() {
  return (
    <aside className="no-print hidden w-60 shrink-0 flex-col border-r border-sidebar-border bg-sidebar p-3 md:flex">
...
/** Mobile top bar — full-width, shown below the masthead on small screens. */
